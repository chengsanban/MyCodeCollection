...
//base sence
static IDirect3DVertexBuffer9* pfloorVertexBuffer = 0;
static IDirect3DTexture9*      pfloorTexture = 0;
static ID3DXMesh*              pPillarMesh = 0;
...
const float I_INFINITY = FLT_MAX;
